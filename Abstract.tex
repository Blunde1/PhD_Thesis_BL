...
% later years has seen a surge in availability of data, use-cases and models.
%Ultimately, this has lead to the branding of a new field now called data science.
%However, with increased flexibility of models to be able to capture complex structural relationship in data, 
...
%, making maximum likelihood estimation difficult. 
...
% motivating boosting procedures is often straight-forward the conditional model can be relatively straight-forward
%This motivates non-parametric procedures such as gradient tree boosting, but which comes with new sets of problems of model selection which currently only have computationally expensive solutions.
...
% in a manner that allows accurate evaluations of log-probability far out in the tails, and which can be made arbitrarily accurate overall. 
...
%, which is particularly attractive, as it often exists in closed form, even for models with more than one source of randomness.
